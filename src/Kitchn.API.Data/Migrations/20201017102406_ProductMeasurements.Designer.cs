...
namespace Kitchn.API.Data.Migrations
{
    ...
    [Migration("20201017102406_ProductMeasurements")]
    partial class ProductMeasurements
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.Battery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.Chore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.Measurement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("3afacf1b-d116-4622-a188-d0c36918efa9"),
                            Name = "Tablet"
                        });
                });

            modelBuilder.Entity("Kitchn.API.Data.Models.MeasurementConversion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GroupMeasurementId");

                    b.HasIndex("IndividualMeasurementId");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("6299ec40-a19b-4feb-9b4b-bb0c805d5dcd"),
                            ConsumeFactor = 4,
                            DefaultBestBefore = new TimeSpan(7, 0, 0, 0, 0),
                            DefaultConsumeWithin = new TimeSpan(4, 0, 0, 0, 0),
                            DefaultLocationId = new Guid("34aef97c-1b6b-4c5e-a33b-38739515de70"),
                            Name = "Milk (2 Pints)"
                        });
                });

            modelBuilder.Entity("Kitchn.API.Data.Models.ProductBarcode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.Recipe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.RecipeCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.RecipeCategoryRecipe", b =>
                {
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.RecipeInstruction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.StockedItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.MeasurementConversion", b =>
                {
                    b.HasOne("Kitchn.API.Data.Models.Measurement", "FromMeasurement")
                        .WithMany()
                        .HasForeignKey("FromMeasurementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kitchn.API.Data.Models.Measurement", "ToMeasurement")
                        .WithMany()
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.Product", b =>
                {
                    b.HasOne("Kitchn.API.Data.Models.Location", "DefaultLocation")
                        .WithMany()
                        .HasForeignKey("DefaultLocationId");

                    b.HasOne("Kitchn.API.Data.Models.Measurement", "GroupMeasurement")
                        .WithMany()
                        .HasForeignKey("GroupMeasurementId");

                    b.HasOne("Kitchn.API.Data.Models.Measurement", "IndividualMeasurement")
                        .WithMany()
                        .HasForeignKey("IndividualMeasurementId");
                });

            modelBuilder.Entity("Kitchn.API.Data.Models.ProductBarcode", b =>
                {
                    b.HasOne("Kitchn.API.Data.Models.Product", "Product")
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.RecipeCategoryRecipe", b =>
                {
                    b.HasOne("Kitchn.API.Data.Models.RecipeCategory", "RecipeCategory")
                        .WithMany("Recipes")
                        .HasForeignKey("RecipeCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Kitchn.API.Data.Models.Recipe", "Recipe")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("Kitchn.API.Data.Models.StockedItem", b =>
                {
                    b.HasOne("Kitchn.API.Data.Models.Location", "Location")
                        .WithMany()
